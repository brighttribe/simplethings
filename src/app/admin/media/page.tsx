...
export default function MediaPage() {
  ...
  // Detect image dimensions when preview changes
  useEffect(() => {
  ...
  return (
    <div>
      ...
      {/* Toolbar: search + grid toggle + count */}
