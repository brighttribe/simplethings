...
const links = [
  ...
  },
  {
    ...
    icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 2v7c0 1.1.9 2 2 2h4a2 2 0 0 0 2-2V2"/><path d="M7 2v20"/><path d="M21 15V2v0a5 5 0 0 0-5 5v6c0 1.1.9 2 2 2h3zm0 0v7"/></svg>,
  },
  {
  ...
  },
  {
    ...
    icon: <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"/><circle cx="8.5" cy="8.5" r="1.5"/><polyline points="21 15 16 10 5 21"/></svg>,
  },
  {
...
export default function AdminSidebar() {
  ...
  return (
    <aside className="w-56 shrink-0 bg-white border-r border-gray-100 h-screen flex flex-col">
      {/* Logo */}
      <div className="px-4 py-5 border-b border-gray-100 flex justify-center">
        <Image src="/logo.png" alt="Simple Things Made Beautiful" width={150} height={75} className="object-contain" />
      </div>
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-2.5 px-3 py-2 rounded-lg text-sm transition-colors ${
                active
                  ? 'bg-[#3d5c3a]/10 text-[#3d5c3a] font-medium'
                  : 'text-gray-500 hover:bg-gray-50 hover:text-gray-900'
              }`}
            >
              <span className={active ? 'text-[#3d5c3a]' : 'text-gray-400'}>{link.icon}</span>
              {link.label}
            </Link>
          )
        })}
